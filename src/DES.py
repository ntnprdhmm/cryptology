...
PFtable = (15, 6, 19, 20, 28, 11, 27, 16, 0, 14, 22, 25, 4, 17, 30, 9, 1, 7, 23, 13, 31, 26, 2, 8, 18, 12, 29, 5, 21, 10, 3, 24)

FPtable = (39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54, 22, 62, 30, 37, 5, 45, 13, 53, 21, 61, 29, 36, 4, 44, 12, 52, 20, 60, 28, 35, 3, 43, 11, 51, 19, 59, 27, 34, 2, 42, 10, 50, 18, 58, 26, 33, 1, 41, 9, 49, 17, 57, 25, 32, 0, 40, 8, 48, 16, 56, 24)
...
class DES:
    ...
    def expansion(self, m):
        ...
        """
        return ''.join([m[i] for i in expansion_table])
    ...
    def permutation(self, c):
        ...
        """
        return ''.join([c[i] for i in PFtable])
...
des = DES()
des.F("110011001100110011001100110011001100110011001100", "11111111000000001111111100000000")
